...
var AjaxCart = {
	...
	effecttocart: true,
	topcartselector: '.shopping .total-amount',
	topwishlistselector: '',
	...
	success_desktop: function (response) {
		...
		if (response.updateflyoutcartsectionhtml) {
			...
			// $(AjaxCart.flyoutcartselector).html($(response.updateflyoutcartsectionhtml).filter(AjaxCart.flyoutcartselector));
			$(AjaxCart.flyoutcartselector).delay(300).queue(function (cb) {
				$(this).addClass('open');
